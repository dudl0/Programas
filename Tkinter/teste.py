...
login_text = customtkinter.CTkLabel(tela,text='Fazer Login',font=('Tahoma',32, 'bold'),fg_color='white',text_color='#006ff9')
...
btn_login = customtkinter.CTkButton(master=tela,text='Login',bg_color='white',font=('Tahoma', 18,'bold'),text_color='white', command=funclick, width=179, height=44)
